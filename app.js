...
let progress={version:"4.3.3",stars:0,today:todayKey(),todayDone:0,completedDesserts:[],ingredients:{flour:0,butter:0,egg:0,milk:0,sugar:0,cheese:0,vegetable:0,meat:0,fish:0,fruit:0},madeFoods:{},rewardedDays:[],rewardCounter:0,rewardHistory:[],words:{},difficulty:{},totals:{attempts:0,correct:0},skillTotals:emptySkills(),bestCombo:0};
...
const CAT_GUIDES={
  meaning:{name:"쁘띠냥 · Petit",src:"./assets/characters/petit-clean-v431.png",line:"단어의 뜻을 차근차근 찾아보자냥!",theme:"petit"},
  article:{name:"쁘띠냥 · Petit",src:"./assets/characters/petit-clean-v431.png",line:"관사와 명사의 성을 함께 확인하자냥!",theme:"petit"},
  form:{name:"쁘띠냥 · Petit",src:"./assets/characters/petit-clean-v431.png",line:"형태가 어떻게 바뀌는지 살펴보자냥!",theme:"petit"},
  listening:{name:"치즈냥 · Fromage",src:"./assets/characters/fromage-clean-v431.png",line:"귀를 쫑긋! 소리를 잘 들어보자냥!",theme:"fromage"},
  example:{name:"라벤더냥 · Lavande",src:"./assets/characters/lavande-clean-v431.png",line:"문장 속 단서를 찾아 읽어보자냥!",theme:"lavande"}
};
...
function renderHome(){
  ...
  if(progress.todayDone>=10){
    ...
    $("homeCat").src="./assets/characters/trio-clean-v431.png";
...
function studyGuideForWord(w){
  if(w.type==="verb")return {name:"치즈냥 · Fromage",src:"./assets/characters/fromage-clean-v431.png",line:"동사의 소리와 활용을 리듬처럼 익혀 보자냥!",theme:"fromage"};
  if(w.example&&String(w.example).length>32)return {name:"라벤더냥 · Lavande",src:"./assets/characters/lavande-clean-v431.png",line:"예문 속에서 단어가 어떻게 쓰이는지 찾아보자냥!",theme:"lavande"};
  return {name:"쁘띠냥 · Petit",src:"./assets/characters/petit-clean-v431.png",line:"단어의 뜻과 성, 형태를 차근차근 확인해 보자냥!",theme:"petit"};
}
...
/* V4.3.3 character motion controller */
...
if("serviceWorker" in navigator)window.addEventListener("load",async()=>{
  try{
    const reg=await navigator.serviceWorker.register("./service-worker.js?v=4.3.3");
    await reg.update();

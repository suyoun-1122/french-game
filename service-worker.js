...
const CORE=[
  "./","./index.html",
  "./style.css?v=4.0.0-b4",
  "./assets/styles/design-system.css?v=4.0.0-b4",
  "./assets/styles/components.css?v=4.0.0-b4",
  "./app.js?v=4.0.0-b4","./audio.js","./review.js",
  "./data/words.json?v=4.0.0-b4","./data/lessons.json?v=4.0.0-b4","./data/recipes.json?v=4.0.0-b4",

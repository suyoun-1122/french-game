const CACHE="yeonjae-french-v4-1-2";
const CORE=[
  "./","./index.html",
  "./style.css?v=4.1.2",
  "./assets/styles/design-system.css?v=4.1.2",
  "./assets/styles/components.css?v=4.1.2",
  "./app.js?v=4.1.2","./audio.js","./review.js",
  "./data/words.json?v=4.1.2","./data/lessons.json?v=4.1.2","./data/recipes.json?v=4.1.2",
